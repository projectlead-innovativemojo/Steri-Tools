...
export default function InvestPopupForm({ closeModal }) {
    ...
    return (
        <div className="relative rounded-3xl bg-white shadow-[0px_3px_8px_0px_#0000003D] w-full max-w-[814px] py-[66px] md:py-[57px] px-[19px] ">
            {/* Close button */}
            <button
                onClick={closeModal}
            ...
            <form className="space-y-[24px] max-w-[507px] mx-auto  bg-white">
                ...
                <div className="w-full">
                    ...
                    <div className="relative">
                        ...
                        {/* Dropdown menu */}
                        {isOpen && (
                            <ul className="absolute left-0 mt-1 w-full rounded-md border border-gray-200 bg-white shadow-md z-10">
                                <li
