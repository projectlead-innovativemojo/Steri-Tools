    ...
    <section className="relative w-full  mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start relative z-10 w-full max-w-[1237px] mx-auto px-5">
        <div className=" lg:pt-12 lg:pl-[99px]">
          ...
          {/* Contact info */}
          <address className="not-italic text-[18px] leading-[24px] md:text-[18px] md:leading-[28px] font-medium text-[#000000]  md:text-left text-center mb-[66px] md:mb-[115px]">
            <div>
              <a
              ...
              <a
                className="block underline"
                href="mailto:Leigh@SteriToolsGlobal.com"
              >
